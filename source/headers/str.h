...
__attribute__((unused)) static __attribute__((always_inline)) __inline__ char *strcpy(x, y)
char *__restrict__ x;
...
__attribute__((unused)) static __attribute__((always_inline)) __inline__ char *strncpy(x, y, z)
char *__restrict__ x;
const char *__restrict__ y;
__SIZE_TYPE__ z;
{
...
__attribute__((unused)) static __attribute__((always_inline)) __inline__ char *strcat(x, y)
char *__restrict__ x;
const char *__restrict__ y;
{
...
__attribute__((unused)) static __attribute__((always_inline)) __inline__ char *stpcpy(x, y)
char *__restrict__ x;
const char *__restrict__ y;
{
...
#ifdef WNONBUILTINS
strerror_r(int, char *, __SIZE_TYPE__)
